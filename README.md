...
The latest user manual is available on [readthedocs]([https://gurobi-machinelearning.readthedocs.io/en/v1.0.0a0/](https://gurobi-optimization-gurobi-machine-learning.readthedocs-hosted.com/en/v1.0.0a0/).
